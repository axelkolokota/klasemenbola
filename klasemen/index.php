...
<body>
    <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
            <h1 class="display-4">Selamat Datang di Aplikasi Klasemen Sepakbola</h1>
            <p class="lead">Dibuat oleh : Axel Kolokota</p>
        </div>
    </div>
    <div class="container">
        <h3 class="text-center">Klasemen Bola</h3>
        <a class="btn btn-primary mb-3" href="add_tim.php" role="button">Tambah Data</a>
        <a class="btn btn-success mb-3" href="update_skor.php" role="button">Update Skor</a>
        <table class="table">
...
<div class="footer">
    <p class="text-center">Copyright &copy; 2023 by Axel Kolokota</p>
</div>
